...
set_input_delay -clock external_clock  $RESET_DELAY  [get_ports rst]	


set_fix_hold internal_clock
set_fix_hold external_clock

set_driving_cell -no_design_rule -lib_cell NBUFFX16 -pin Q [get_ports ext_clk]
